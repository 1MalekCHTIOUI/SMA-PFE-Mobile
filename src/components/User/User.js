...
const User = ({user, online}) => {
    ...
    return (
        <Pressable style={styles.item} key={user._id} onPress={() => userHasRoom(data)}>
            {
                ...
                <View key={user._id} style={{position:'relative'}}>
                    ...
                    <View style={online ? [styles.dot, {backgroundColor: '#1dc249'}] : [styles.dot, {backgroundColor: 'red'}]}></View>
                </View>
            }
